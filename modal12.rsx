...
"
  ...
  <Text
    ...
    _disclosedFields={{ array: [] }}
    marginType="normal"
    value="**THE ABOVE UNITS WILL BE TRANSFERRED INTO YOUR INVENTORY @ LINE 310 AND MSO(S) WILL BE FORWARDED. YOU WILL BE RECEIVING A CHECK IN THE AMOUNT OF**"
    verticalAlign="center"
  />
  <NumberInput
    id="currency35"
    ...
    showSeparators={true}
    showStepper={true}
    value="{{landUnderNumberInput.value}}"
  />
  <Text
    id="text70"
    _defaultValue=""
    _disclosedFields={{ array: [] }}
    marginType="normal"
    value="**FROM THE DEALER TRADE NETWORK**"
    verticalAlign="center"
  />
</Modal>
